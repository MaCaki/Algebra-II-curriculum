...
\subsection*{1}
Graph the equation $$ y = (x+5)^2 +  1$$ and clearly label the vertex.   \\
...
\begin{pspicture*}(-6.81,-7.48)(5.38,4.79)
\psgrid[subgriddiv=0,gridlabels=0,gridcolor=lightgray](0,0)(-6.81,-7.48)(5.38,4.79)
\psset{xunit=1.0cm,yunit=1.0cm,algebraic=true,dotstyle=o,dotsize=3pt 0,linewidth=0.8pt,arrowsize=3pt 2,arrowinset=0.25}
\psaxes[labelFontSize=\scriptstyle,xAxis=true,yAxis=true,Dx=1,Dy=1,ticksize=-2pt 0,subticks=2]{->}(0,0)(-6.81,-7.48)(5.38,4.79)
\rput{-180}(-2,-1){\psplot{-4}{4}{x^2/2/0.5}}
\end{pspicture*}
