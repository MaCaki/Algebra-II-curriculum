...
\subsection*{1}
Convert the following factored quadratic equation into standard form and vertex form: 
$$ f(x) = -(x-3)(x-5) $$


\newpage
\subsection*{2}  Write the following standard form quadratic equation in vertex form and then graph it: 
$$ y = x^2 -6x + 11 $$
\ansbox
\graph 
